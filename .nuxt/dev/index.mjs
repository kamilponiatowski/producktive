...
var hero$1 = {
	...
	proof3: "Błyskawiczna realizacja",
...
var services$1 = {
	...
	items: {
		website: {
			...
			desc: "Twoja firma zasługuje na stronę, która nie tylko dobrze wygląda, ale i błyskawicznie działa. Szybka, mobilna, optymalna pod SEO oraz GEO — czyli wyniki wyszukiwania w Google oraz optymalizacja pod wyszukiwarki wspomagane przez AI (ChatGPT, Perplexity, Google AI Overviews, Claude itp.)",
...
var about$1 = {
	...
	avatarAlt: "Kamil Poniatowski — twórca Producktive",
	skills: {
		frontend: "Frontend",
		backend: "Backend",
		design: "Design",
...
var community$1 = {
	...
	subtitle: "Każdy klient Producktive ma możliwość dołączenia do \"1-All-1\" — czyli dołącza do sieci przedsiębiorców, którzy wzajemnie sobie pomagają — priorytetowo, na atrakcyjnych warunkach, często poza standardowymi schematami.",
...
var services = {
	...
	items: {
		website: {
			...
			desc: "Your company deserves a website that not only looks great but loads blazingly fast. Fast, mobile-first, SEO and GEO-optimized — search results in Google and optimization for AI-powered search engines (ChatGPT, Perplexity, Google AI Overviews, Claude, etc.)",
			price: "€700 – €1,400",
			days: "7–10 days"
		},
		landing: {
...
var about = {
	...
	howIWork: "How I work",
	avatarAlt: "Kamil Poniatowski — creator of Producktive",
	skills: {
		frontend: "Frontend",
		backend: "Backend",
		design: "Design",
...
var community = {
	...
	subtitle: "Every Producktive client can join \"1-All-1\" — a network of entrepreneurs who support each other — with priority service, preferential rates, and collaborations beyond standard market norms.",
