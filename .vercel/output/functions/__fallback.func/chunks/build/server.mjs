...
import { ref, inject, computed, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowRef, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, nextTick, mergeProps, getCurrentScope, toRef, isReadonly, toValue, isRef, isShallow, isReactive, toRaw } from 'vue';
import { z as klona, A as parseURL, B as encodePath, C as decodePath, D as hasProtocol, E as isScriptProtocol, v as joinURL, w as withQuery, F as getRequestHeader, G as destr, H as isEqual, I as sanitizeStatusCode, J as setCookie, K as getCookie, L as deleteCookie, M as getContext, $ as $fetch$1, N as baseURL, O as defu, c as createError$1, P as executeAsync, Q as withHttps, R as withoutTrailingSlash, S as titleCase, T as stringifyQuery, U as camelCase, V as withLeadingSlash, W as withBase, X as withTrailingSlash, Y as getRequestURL, Z as parsePath, p as parseQuery, _ as createDefu, a0 as isEqual$1 } from '../_/nitro.mjs';
...
import { u as useHead$1, h as headSymbol, a as useSeoMeta$1, b as useServerSeoMeta$1 } from '../routes/renderer.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const matcher = /* @__PURE__ */ (() => {
  ...
  return (m, p) => {
    ...
    if (p === "/__sitemap__/style.xsl") {
      ...
      r.unshift({ data: $0 });
    } else if (p === "/__sitemap__/pl-PL.xml") {
      r.unshift({ data: $0 });
...
const component_45stub_45L_ro2hYIpGEdvQ6OC_u7V31JOtzbzNbFF457vIQxSk = {};
const _routes = [
  {
    name: "index___pl",
    path: "/",
    component: () => import('./index-DImu_1Z_.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    ...
    component: () => import('./polityka-prywatnosci-cSxsK8sk.mjs')
  },
  {
  ...
  },
  {
    ...
    path: "/sitemap.xml",
    component: component_45stub_45L_ro2hYIpGEdvQ6OC_u7V31JOtzbzNbFF457vIQxSk
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/en/sitemap.xml",
...
function applyDefaults() {
  ...
  const head = injectHead();
  head.use(TemplateParamsPlugin);
  const { canonicalQueryWhitelist, canonicalLowercase, tagPriority } = (/* @__PURE__ */ useRuntimeConfig()).public["seo-utils"];
  const route = useRoute();
  ...
  pl: [
    {
      ...
      load: () => import(
        './pl-BbhQq3GP.mjs'
        /* webpackChunkName: "locale_pl_46json_1c1016c8" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-C0AOz4Pl.mjs'
        /* webpackChunkName: "locale_en_46json_4c1b50aa" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/M_T88Df5"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/M_T88Df5"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CC_n4cdD.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cnyg8wha.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DJcWDdKj.mjs'));
...
export { useI18n as a, useRuntimeConfig as b, useCookie as c, useRouter as d, entry_default as default, encodeRoutePath as e, useNuxtApp as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, useHead as u };
