...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "9cd01790-8b97-4311-834c-01e534561b13",
...
var services$1 = {
	...
	items: {
		...
		blog: {
			...
			price: "4 000 – 8 000 zł",
			days: "10–14 dni"
		},
		shop: {
			title: "Sklep online",
			desc: "Sprzedawaj 24/7 bez ograniczeń geograficznych. Płatności Stripe, zarządzanie produktami, panel admina — bez WooCommerce.",
		...
		design: {
			title: "UI/UX Design",
			desc: "Projekt graficzny realizowany we współpracy z doświadczonymi designerami i ekspertami UX. Makiety, system designu, prototyp do testów z użytkownikami.",
			price: "2 500 – 5 000 zł",
			days: "5–7 dni"
		}
	}
...
var portfolio$1 = {
	...
	projects: {
		miralive: {
			...
			desc: "Nowoczesna strona wizytówkowa dla agencji ubezpieczeniowej z Włocławka. Priorytetem było SEO i wiarygodność — w pełni statyczna strona, która ładuje się w ułamku sekundy.",
			label: "Klient · Live",
...
var contact$1 = {
	...
	direct: {
		...
		email: "kontakt{'@'}producktive.pl",
		phone: "+48 886 127 854"
	},
	guarantee: {
		title: "Gwarancja satysfakcji",
		desc: "Jeśli nie będziesz zadowolony z projektu na etapie designu, {highlight} Zależy mi na Twojej rekomendacji, nie tylko na wykonaniu zlecenia.",
		highlight: "zwracam zaliczkę za ten etap."
	},
	faq: {
		title: "FAQ",
...
var community$1 = {
	badge: "Sieć Producktive",
	title: "Jeden za wszystkich,",
	titleHighlight: "wszyscy za jednego.",
	subtitle: "Każdy klient Producktive dołącza do sieci przedsiębiorców, którzy wzajemnie sobie pomagają — priorytetowo, na atrakcyjnych warunkach, często poza standardowymi schematami.",
	networkTitle: "Co daje Ci sieć?",
	benefit1Title: "Priorytetowy dostęp",
	benefit1Desc: "Klienci Producktive obsługują się wzajemnie poza kolejką — szybciej i z lepszym podejściem.",
	benefit2Title: "Atrakcyjne warunki",
	benefit2Desc: "Specjalne stawki i warunki współpracy między klientami sieci, niedostępne dla klientów standardowych.",
	benefit3Title: "Poza schematami",
	benefit3Desc: "Elastyczna umowa ramowa, która daje przestrzeń na niestandardowe formy współpracy: bartery, projekty wymienne, partnerstwa.",
	resourcesTitle: "Darmowe zasoby produktywności",
	resourcesDesc: "Każdy klient Producktive otrzymuje dostęp do bazy wiedzy, która napędza wzrost:",
	resource1: "Przewodnik PDF: Narzędzia i techniki produktywności (80/20, Pomodoro, Deep Work)",
	resource2: "Techniki oddechowe i zarządzanie stresem dla przedsiębiorców",
	resource3: "Wzorce i szablony dla małych firm",
	resource4: "Dostęp do aktualizowanej bazy pigułek wiedzy",
	cta: "Zostań częścią sieci →"
};
var footer$1 = {
...
var popup$1 = {
	title: "Porozmawiajmy!",
	desc: "Zostaw numer – oddzwonię w ciągu 24h i odpowiem na wszelkie pytania.",
	phonePlaceholder: "+48 xxx xxx xxx",
	consent: "Wyrażam zgodę na kontakt telefoniczny w celu omówienia możliwości współpracy.",
	submit: "Wyślij numer →",
	submitting: "Wysyłanie...",
...
var services = {
	...
	items: {
		...
		blog: {
			title: "Blog & Content",
			desc: "Create content that positions your company as an expert. A CMS panel tailored for non-technical users.",
			price: "€950 – €1,900",
			days: "10–14 days"
		},
		shop: {
			title: "Online Store",
			desc: "Sell 24/7 without geographical limits. Stripe payments, product management, admin panel — no WooCommerce.",
			price: "€1,400 – €2,800",
			days: "14–21 days"
		},
		saas: {
		...
		design: {
			title: "UI/UX Design",
			desc: "Design delivered in collaboration with experienced designers and UX experts. Wireframes, design system, prototype for user testing.",
			price: "€600 – €1,200",
			days: "5–7 days"
		}
	}
...
var contact = {
	...
	guarantee: {
		...
		desc: "If you're not satisfied with the project at the design stage, {highlight} I care about your recommendation, not just completing the order.",
		highlight: "I return the deposit for that stage."
	},
	faq: {
		title: "FAQ",
...
var community = {
	badge: "Producktive Network",
	title: "One for all,",
	titleHighlight: "all for one.",
	subtitle: "Every Producktive client joins a network of entrepreneurs who support each other — with priority service, preferential rates, and collaborations beyond standard market norms.",
	networkTitle: "What does the network give you?",
	benefit1Title: "Priority access",
	benefit1Desc: "Producktive clients serve each other ahead of the queue — faster and with a better approach.",
	benefit2Title: "Attractive terms",
	benefit2Desc: "Special rates and collaboration terms for network members, unavailable to standard clients.",
	benefit3Title: "Beyond the norm",
	benefit3Desc: "A flexible framework agreement that allows non-standard collaboration: barters, exchange projects, partnerships.",
	resourcesTitle: "Free productivity resources",
	resourcesDesc: "Every Producktive client gets access to a knowledge base that drives growth:",
	resource1: "PDF Guide: Productivity tools and techniques (80/20, Pomodoro, Deep Work)",
	resource2: "Breathing techniques and stress management for entrepreneurs",
	resource3: "Patterns and templates for small businesses",
	resource4: "Access to an updated knowledge pill database",
...
var popup = {
	title: "Let's talk!",
	desc: "Leave your number – I'll call back within 24h to answer any questions.",
	phonePlaceholder: "+48 xxx xxx xxx",
	consent: "I consent to being contacted by phone to discuss collaboration possibilities.",
	submit: "Send number →",
	submitting: "Sending...",
	success: "Thank you! I'll reach out soon.",
	close: "Close",
	privacy: "Your data is safe. I don't share it with third parties."
};
var a11y = {
...
const _RIvJzxT6nZhEcCHAegTyCTPxDjV7CUPpnau7KSuhrc = defineNitroPlugin(async (nitro) => {
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/M_T88Df5") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const _vwQk3r = _messagesHandlerCached;
...
const _lazy_cDnx8G = () => import('../routes/api/contact.post.mjs');
const _lazy_LHQcUv = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });
const _lazy_d_AG3a = () => import('../routes/sitemap_index.xml.mjs');
const _lazy_8qrWue = () => import('../routes/__sitemap__/_sitemap_.xml.mjs');
...
export { $fetch$1 as $, parseURL as A, encodePath as B, decodePath as C, hasProtocol as D, isScriptProtocol as E, getRequestHeader as F, destr as G, isEqual as H, sanitizeStatusCode as I, setCookie as J, getCookie as K, deleteCookie as L, getContext as M, baseURL as N, defu as O, executeAsync as P, withHttps as Q, withoutTrailingSlash as R, titleCase as S, stringifyQuery as T, camelCase as U, withLeadingSlash as V, withBase as W, withTrailingSlash as X, getRequestURL as Y, parsePath as Z, createDefu as _, useRuntimeConfig as a, isEqual$1 as a0, appRootTag as b, createError$1 as c, defineEventHandler as d, appRootAttrs as e, buildAssetsURL as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, appId as j, defineRenderHandler as k, publicAssetsURL as l, appTeleportTag as m, appTeleportAttrs as n, getQuery as o, parseQuery as p, appHead as q, readBody as r, getRouteRules as s, toNodeListener as t, useNitroApp as u, joinURL as v, withQuery as w, sitemapIndexXmlEventHandler as x, sitemapChildXmlEventHandler as y, klona as z };
